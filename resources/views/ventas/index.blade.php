        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 text-center">
                    <a href="{{ route('ventas.store') }}" class="btn btn-primary">Agregar<i class="fas fa-plus ml-2"></i></a>
                </div>
                <div class="col-12"><br>
                                ...
                                @else
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('ventas.show', $item->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-eye"></i></a>
