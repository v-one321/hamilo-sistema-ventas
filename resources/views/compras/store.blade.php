                                        ...
                                        @foreach ($productos as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('compras.agregar-carrito', $item->id) }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-plus"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <div class="table-responsive"><br>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @if (count($carrito) == 0)
                                        <tr>
                                            <td class="text-center" colspan="6"><span class="badge bg-danger">No tiene productos registrados</span></td>
                                        </tr>
                                    @else
                                        @foreach ($carrito as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('compras.decrementar-carrito', $item->id) }}" class="btn btn-danger btn-sm"><i class="fas fa-minus"></i></a>
                                                        <button type="button" class="btn btn-primary btn-sm">{{ $item->cantidad }}</button>
                                                        <a href="{{ route('compras.incrementar-carrito', $item->id) }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i></a>
                                                    </div>
                                                </td>
                                                <td>{{ $item->precio_unitario }}</td>
                                                <td>{{ $item->total }}</td>
                                                <td class="text-center">
                                                    <a href="{{ route('compras.eliminar-carrito', $item->id) }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
