        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 text-center">
                    <a href="{{ route('productos.create') }}" class="btn btn-primary">Agregar<i class="fas fa-plus ml-2"></i></a>
                </div>
                <div class="col-12"><br>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @if (count($datos) == 0)
                                    <tr>
                                        <td class="text-center" colspan="9"><span class="badge bg-danger">No tiene registros</span></td>
                                    </tr>
                                @else
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('productos.edit', $item->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit"></i></a>
