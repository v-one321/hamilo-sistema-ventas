...
@section('contenido')
    <div class="card">
        ...
        <form action="{{ route('productos.update', $item->id) }}" method="post" class="needs-validation" novalidate autocomplete="off">
            @method('PUT')
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" name="nombre" id="nombre" value="{{ old('nombre', $item->nombre) }}"
                            required>
                        @error('nombre')
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" name="codigo" id="codigo" value="{{ old('codigo', $item->codigo) }} "required>
                        @error('codigo')
                            <small class="text-danger"><i class="fas fa-times mr-1"></i>{{ $message }}</small>
                        @enderror
                        <div class="valid-feedback">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" name="precio_compra" id="precio_compra"
                            value="{{ old('precio_compra', $item->precio_compra) }}" required>
                        @error('precio_compra')
                            <small class="text-danger"><i class="fas fa-times mr-1"></i>{{ $message }}</small>
                        @enderror
                        <div class="valid-feedback">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" name="precio_venta" id="precio_venta"
                            value="{{ old('precio_venta', $item->precio_venta) }}" required>
                        @error('precio_venta')
                            <small class="text-danger"><i class="fas fa-times mr-1"></i>{{ $message }}</small>
                        @enderror
                        <div class="valid-feedback">
