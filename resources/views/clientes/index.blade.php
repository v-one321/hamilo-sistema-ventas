        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 text-center">
                    <a href="{{ route('clientes.create') }}" class="btn btn-primary">Agregar<i class="fas fa-plus ml-2"></i></a>
                </div>
                <div class="col-12"><br>
                                ...
                                @else
                                    @foreach ($datos as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('clientes.edit', $item->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit"></i></a>
